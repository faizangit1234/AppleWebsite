            ...
            <div className="screen-max-width ">
                ...
                <div className="flex flex-col justify-center items-center overflow-hidden">
                    <div className="mt-32 mb-24 pl-24">
                        <h2 className='text-5xl lg:t-7xl font-semibold text-gray-100'>iPhone</h2>
                        <h2 className='text-5xl lg:t-7xl font-semibold text-gray-200'>Forged in Titanium</h2>
                    </div>
                    <div className="flex-center flex-col sm:px-10 ">
                        ...
                        <div className="flex flex-col w-full mt-2 relative">
                            ...
                            <div className="feature-text-container">
                                ...
                                <div className="flex-1 flex-center">
                                    <p className='feature-text g_text'>Titanium has one of the best strength-to-weight ratios of any metal, making these are  {''}
                                        <span className='text-white'>
