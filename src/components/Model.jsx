                        ...
                        <div className="flex-center">
                            ...
                            <button className="size-btn-container">
                                {sizes.map(({ label, value }) => (
                                    <span className='size-btn' style={{ backgroundColor: size === value ? 'white' : 'transparent', color: size === value ? 'black' : 'white' }} key={label} onClick={() => setSize(value)}>
                                        {label}
                                    </span>
                                ))}
                            </button>
